...
//                System.out.println("clicked!");
    ...
    private void xuLyHienThiCacMonTotNghiep() {
        ...
        MonHocTinChiDaTotNghiep = SerilizeFactory.docFile("MonHocTinChiDaTotNghiep.db");
...
//        MonHocTinChi mh = new MonHocTinChi(TenMonHoc, soTinChi, MonHocTinChiSelected, diemGiuaKy, diemCuoiKy);
        ...
        if (SerilizeFactory.luuFile(MonHocTinChiDaTotNghiep, "MonHocTinChiDaTotNghiep.db")) {
            return true;
        }
        return false;
    }
